 ...
 */
function fattenLine(line, rng, min, max){
...
export class ExpandAreaConnect{
     ...
     */
    runAlgorithm(inputLocation, prevLocations, rng, minWidth = 1, maxWidth = 4){  
        ...
        let line2 = fattenLine(line1, rng, minWidth, maxWidth);
